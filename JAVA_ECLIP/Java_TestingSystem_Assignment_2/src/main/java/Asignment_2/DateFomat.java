...
//			System.out.println("category_ID: " + exam1.category_ID.categoryId);
//			System.out.println("duration: " + exam1.duration);
//			System.out.println("creator_Id: " + exam1.creator_Id.accountId); 
//			Locale locale = new Locale("vi","VN");
//			DateFormat dateFormat = DateFormat.getDateInstance(DateFormat.DEFAULT,locale);
//			String dateExam1 = dateFormat.format(exam1.createDate);
//			System.out.println("DateExam1: " + dateExam1 ); 
//		
		    //cach2
//			String pattern = "dd-MM-yyyy";
//			SimpleDateFormat simpleDateFormat = new SimpleDateFormat(pattern);
//			String dateExam1 = simpleDateFormat.format(exam1.createDate);
//			System.out.println(dateExam1);
